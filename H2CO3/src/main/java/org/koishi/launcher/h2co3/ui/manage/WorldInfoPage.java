...
public class WorldInfoPage extends H2CO3LauncherTempPage {
    ...
    private H2CO3LauncherTextView gameVersion;
    private H2CO3LauncherTextView seed;
    private H2CO3LauncherTextView lastPlayed;
    private H2CO3LauncherTextView time;
    private H2CO3LauncherSwitch allowCheat;
    private H2CO3LauncherSwitch generateStructure;
    private H2CO3LauncherSpinner<Difficulty> difficulty;

    private H2CO3LauncherLinearLayout playerInfo;
    private H2CO3LauncherTextView location;
    private H2CO3LauncherTextView lastDeath;
    private H2CO3LauncherTextView spawn;
    private H2CO3LauncherSpinner<GameType> gameType;
    private H2CO3LauncherEditText health;
    private H2CO3LauncherEditText foodLevel;
    private H2CO3LauncherEditText xpLevel;

    public WorldInfoPage(Context context, int id, H2CO3LauncherUILayout parent, int resId, World world) throws IOException {
    ...
    private enum Difficulty {
        ...
        public String toString() {
            return AndroidUtils.getLocalizedText(H2CO3LauncherTools.CONTEXT, "world_info_difficulty_" + name().toLowerCase(Locale.ROOT));
        }
    }
    ...
    private enum GameType {
        ...
        @Override
        public String toString() {
            return AndroidUtils.getLocalizedText(H2CO3LauncherTools.CONTEXT, "world_info_player_game_type_" + name().toLowerCase(Locale.ROOT));
        }
    }

    private static final class Dimension {
        static final Dimension OVERWORLD = new Dimension(null);
        static final Dimension THE_NETHER = new Dimension(H2CO3LauncherTools.CONTEXT.getString(R.string.world_info_dimension_the_nether));
        static final Dimension THE_END = new Dimension(H2CO3LauncherTools.CONTEXT.getString(R.string.world_info_dimension_the_end));
