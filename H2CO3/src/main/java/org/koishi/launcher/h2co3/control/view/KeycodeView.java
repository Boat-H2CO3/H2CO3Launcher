...
public class KeycodeView extends androidx.appcompat.widget.AppCompatButton {
    ...
    public KeycodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, org.koishi.launcher.h2co3library.R.styleable.KeycodeView);
        this.keycode = typedArray.getInteger(org.koishi.launcher.h2co3library.R.styleable.KeycodeView_keycode, -1);
        typedArray.recycle();
        checkSelection(new ArrayList<>());
