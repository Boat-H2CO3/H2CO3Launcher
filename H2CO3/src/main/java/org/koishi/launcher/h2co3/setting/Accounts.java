...
import static org.koishi.launcher.h2co3core.util.Lang.immutableListOf;
...
import org.koishi.launcher.h2co3core.auth.NoCharacterException;
...
import org.koishi.launcher.h2co3core.auth.authlibinjector.AuthlibInjectorArtifactInfo;
import org.koishi.launcher.h2co3core.auth.authlibinjector.AuthlibInjectorArtifactProvider;
import org.koishi.launcher.h2co3core.auth.authlibinjector.AuthlibInjectorDownloadException;
import org.koishi.launcher.h2co3core.auth.authlibinjector.AuthlibInjectorDownloader;
...
import org.koishi.launcher.h2co3core.auth.microsoft.MicrosoftService;
...
import org.koishi.launcher.h2co3core.auth.yggdrasil.RemoteAuthenticationException;
import org.koishi.launcher.h2co3core.auth.yggdrasil.YggdrasilAccount;
import org.koishi.launcher.h2co3core.auth.yggdrasil.YggdrasilAccountFactory;
...
public final class Accounts {
    ...
    private static void loadGlobalAccountStorages() {
        Path globalAccountsFile = new File(H2CO3LauncherTools.FILES_DIR, "accounts.json").toPath();
    ...
    private static AuthlibInjectorArtifactProvider createAuthlibInjectorArtifactProvider() {
        String authlibinjectorLocation = H2CO3LauncherTools.AUTHLIB_INJECTOR_PATH;
