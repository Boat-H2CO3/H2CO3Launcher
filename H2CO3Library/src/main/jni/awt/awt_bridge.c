...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    if (dalvikJavaVMPtr == NULL) {
        ...
        method_OpenLink = (*env)->GetStaticMethodID(env, class_H2CO3LauncherBridge, "openLink",
                                                    "(Ljava/lang/String;)V");
        method_QuerySystemClipboard = (*env)->GetStaticMethodID(env, class_H2CO3LauncherBridge,
                                                                "querySystemClipboard", "()V");
        method_PutClipboardData = (*env)->GetStaticMethodID(env, class_H2CO3LauncherBridge,
                                                            "putClipboardData",
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCClipboard_nQuerySystemClipboard(JNIEnv *env, jclass clazz) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_H2CO3LauncherBridge, method_QuerySystemClipboard);
    if(detachable) (*dalvikJavaVMPtr)->DetachCurrentThread(dalvikJavaVMPtr);
}
...
JNIEXPORT void JNICALL Java_net_java_openjdk_cacio_ctc_CTCClipboard_nPutClipboardData(JNIEnv* env, jclass clazz, jstring clipboardData, jstring clipboardDataMime) {
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_H2CO3LauncherBridge, method_PutClipboardData,
...
JNIEXPORT jintArray JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_renderAWTScreenFrame(JNIEnv* env, jclass clazz) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_nativeSendData(JNIEnv* env, jclass clazz, jint type, jint i1, jint i2, jint i3, jint i4) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_nativeClipboardReceived(JNIEnv *env, jclass clazz, jstring clipboardData, jstring clipboardDataMime) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_nativeMoveWindow(JNIEnv *env, jclass clazz, jint x, jint y) {
    if (runtimeJNIEnvPtr_INPUT == NULL) {
        if (runtimeJavaVMPtr == NULL) {
            return;
        } else {
