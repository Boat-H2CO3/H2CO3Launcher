...
JNIEXPORT jint JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_redirectStdio(JNIEnv* env, jobject jobject, jstring path) {
    ...
    jclass bridge = (*env) -> FindClass(env, "org/koishi/launcher/h2co3launcher/bridge/H2CO3LauncherBridge");
...
JNIEXPORT jint JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_chdir(JNIEnv* env, jobject jobject, jstring path) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_setenv(JNIEnv* env, jobject jobject, jstring str1, jstring str2) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_setLdLibraryPath(JNIEnv *env, jobject jobject, jstring ldLibraryPath) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3launcher_bridge_H2CO3LauncherBridge_setupExitTrap(JNIEnv *env, jobject jobject1, jobject bridge) {
    exitTrap_bridge = (*env)->NewGlobalRef(env, bridge);
    (*env)->GetJavaVM(env, &exitTrap_jvm);
    jclass exitTrap_exitClass = (*env)->NewGlobalRef(env,(*env)->FindClass(env, "org/koishi/launcher/h2co3launcher/bridge/H2CO3LauncherBridge"));
