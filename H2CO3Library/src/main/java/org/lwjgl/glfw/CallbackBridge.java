...
public class CallbackBridge {
    ...
    private static H2CO3LauncherBridge h2co3LauncherBridge = null;
    private static boolean isGrabbing = false;
    private static final Consumer<Boolean> grabListener = isGrabbing -> CallbackBridge.h2co3LauncherBridge.setCursorMode(isGrabbing ? H2CO3LauncherBridge.CursorDisabled : H2CO3LauncherBridge.CursorEnabled);
    ...
    public static @Nullable String accessAndroidClipboard(int type, String copy) {
        ...
        switch (type) {
            ...
            case CLIPBOARD_OPEN:
                H2CO3LauncherBridge.openLink(copy);
                return null;
            default:
                return null;
        }
    ...
    public static void setH2CO3LauncherBridge(H2CO3LauncherBridge h2co3LauncherBridge) {
        CallbackBridge.h2co3LauncherBridge = h2co3LauncherBridge;
    }
