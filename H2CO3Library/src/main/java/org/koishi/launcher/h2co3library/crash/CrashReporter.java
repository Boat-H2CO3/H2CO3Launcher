package org.koishi.launcher.h2co3library.crash;
...
public final class CrashReporter {
    ...
    private static final String EXTRA_CONFIG = "org.koishi.launcher.h2co3library.crash.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "org.koishi.launcher.h2co3library.crash.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "org.koishi.launcher.h2co3library.crash.EXTRA_ACTIVITY_LOG";
    private static final String EXTRA_CUSTOM_CRASH_DATA = "org.koishi.launcher.h2co3library.crash.EXTRA_CUSTOM_CRASH_DATA";

    // General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "org.koishi.launcher.h2co3library.crash.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "org.koishi.launcher.h2co3library.crash.RESTART";
    private static final String REPORTER_HANDLER_PACKAGE_NAME = "org.koishi.launcher.h2co3library.crash";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="org.koishi.launcher.h2co3library.crash.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="org.koishi.launcher.h2co3library.crash.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="org.koishi.launcher.h2co3library.crash.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="org.koishi.launcher.h2co3library.crash.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
