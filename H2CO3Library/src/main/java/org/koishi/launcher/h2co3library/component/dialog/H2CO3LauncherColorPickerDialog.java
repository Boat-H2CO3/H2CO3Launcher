...
import org.koishi.launcher.h2co3library.component.view.color.ColorPickerView;

public class H2CO3LauncherColorPickerDialog extends H2CO3LauncherDialog implements View.OnClickListener, TextView.OnEditorActionListener, ColorPickerView.OnColorChangedListener {
    ...
    private H2CO3LauncherEditText editColor;
    private H2CO3LauncherButton positive;
    private H2CO3LauncherButton negative;

    public H2CO3LauncherColorPickerDialog(@NonNull Context context, int initColor, Listener listener) {
        super(context);
