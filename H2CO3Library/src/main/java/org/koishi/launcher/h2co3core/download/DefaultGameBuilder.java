...
public class DefaultGameBuilder extends GameBuilder {
    ...
    public Task<?> buildAsync() {
        ...
        stages.add("h2co3Launcher.install.game:" + gameVersion);
        stages.add("h2co3Launcher.install.assets");
        ...
        for (Map.Entry<String, String> entry : toolVersions.entrySet()) {
            ...
            stages.add(String.format("h2co3Launcher.install.%s:%s", entry.getKey(), entry.getValue()));
        }
