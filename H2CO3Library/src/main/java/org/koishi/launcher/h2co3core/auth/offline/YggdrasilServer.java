 ...
 */
package org.koishi.launcher.h2co3core.auth.offline;
...
import org.koishi.launcher.h2co3core.util.KeyUtils;
...
import org.koishi.launcher.h2co3core.util.io.HttpServer;
import org.koishi.launcher.h2co3core.util.png.fakefx.PNGFakeFXUtils;
...
public class YggdrasilServer extends HttpServer {
    ...
    private Response root(Request request) {
        return ok(mapOf(
                ...
                pair("meta", mapOf(
                        pair("serverName", "H2CO3Launcher"),
                        pair("implementationName", "H2CO3Launcher"),
