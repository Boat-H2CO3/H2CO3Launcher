 ...
 */
package org.koishi.launcher.h2co3core.mod.mcbbs;

import static org.koishi.launcher.h2co3core.util.Lang.wrap;
import static org.koishi.launcher.h2co3core.util.Lang.wrapConsumer;
...
import org.koishi.launcher.h2co3core.mod.curse.CurseMetaMod;
import org.koishi.launcher.h2co3core.task.CompletableFutureTask;
import org.koishi.launcher.h2co3core.task.FileDownloadTask;
import org.koishi.launcher.h2co3core.task.GetTask;
import org.koishi.launcher.h2co3core.task.Task;
import org.koishi.launcher.h2co3core.task.TaskCompletableFuture;
...
public class McbbsModpackCompletionTask extends CompletableFutureTask<Void> {
    ...
    public McbbsModpackCompletionTask(DefaultDependencyManager dependencyManager, String version, ModpackConfiguration<McbbsModpackManifest> configuration) {
        ...
        setStage("h2co3Launcher.modpack.download");
    }
                            ...
                            if (file instanceof McbbsModpackManifest.CurseFile) {
                                ...
                                if (StringUtils.isNotBlank(curseFile.getFileName())) {
                                    if (!modManager.hasSimpleMod(curseFile.getFileName())) {
                                        ...
                                        dependencies.add(task.withCounter("h2co3Launcher.modpack.download"));
                                    }
                                }
                            }
