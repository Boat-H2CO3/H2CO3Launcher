 ...
 * see {@link org.koishi.launcher.h2co3core.download.DependencyManager}
 */
public interface GameRepository extends VersionProvider {
    ...
    default Set<String> getClasspath(Version version) {
        ...
        if (H2CO3LauncherBridge.BACKEND_IS_H2CO3) {
            classpath.add(H2CO3LauncherTools.LWJGL_DIR + "-h2co3/lwjgl.jar");
        } else {
            classpath.add(H2CO3LauncherTools.LWJGL_DIR + "/lwjgl.jar");
        }
