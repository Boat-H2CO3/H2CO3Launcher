...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3_core_launch_H2CO3LauncherBridge_setH2CO3LauncherBridge(JNIEnv *env, jobject thiz, jobject h2co3Launcher_bridge) {
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3_core_launch_H2CO3LauncherBridge_setH2CO3LauncherNativeWindow(JNIEnv* env, jclass clazz, jobject surface) {
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    if (h2co3Launcher->android_jvm == NULL) {
        ...
        jclass class_H2CO3LauncherBridge = (*env)->FindClass(env, "org/koishi/launcher/h2co3/core/launch/H2CO3LauncherBridge");
        if (class_H2CO3LauncherBridge == 0) {
            H2CO3Launcher_INTERNAL_LOG("Failed to find class: org/koishi/launcher/h2co3/core/launch/H2CO3LauncherBridge.");
            abort();
        }
...
Java_org_koishi_launcher_h2co3_core_launch_H2CO3LauncherBridge_nativeGetFps(JNIEnv *env, jclass clazz) {
